...
This is compatible with the ERC721 standard, except for the interfaceId. For this reason, it could be better to expose a different way to verify if a contract is MCIP1-compatible, something like
```solidity 
...
[https://github.com/ndujaLabs/erc721playable](https://github.com/ndujaLabs/erc721playable)
